...
<body>
	<div class="container">
		<form id="userForm" method="POST" action="${contextPath}/login">
			<div class="imgcontainer">
				<!-- <img src="http://calibratedadvisory.com/user/img_avatar2.png"
					alt="Avatar" class="avatar" style="align: center"> -->
			</div>
